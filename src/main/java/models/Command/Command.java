/**
 * The Command class represents a command that can be executed in the game.
 * It encapsulates information such as the command name, description, and arguments.
 */
package main.java.models.Command;
